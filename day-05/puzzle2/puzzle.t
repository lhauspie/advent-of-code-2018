...
is(remove_unit('absdefxXpoiyAt', 'a'), 'bsdefxXpoiyt', 'should remove a and A');
is(remove_unit('absdefxXpoiyAt', 'A'), 'bsdefxXpoiyt', 'should remove a and A');

is(shortest_reacted_polymer('abcxXdXefxXyYghbb'), 'acdXefgh', 'by removing b the reacted polymer size should be 8');